...
const initialStudents = [
  { name: 'Rohan Mehta', parentName: 'Suresh Mehta', parentPhone: '9876543210', section: '9th', totalFee: 12000, rollNumber: '901', address: 'Juhapura, Ahmedabad', joinedDate: '2026-06-01' },
  { name: 'Priya Sharma', parentName: 'Anil Sharma', parentPhone: '9823456789', section: '9th', totalFee: 12000, rollNumber: '902', address: 'Sharifabad, Ahmedabad', joinedDate: '2026-06-01' },
  { name: 'Amit Desai', parentName: 'Rajesh Desai', parentPhone: '9712345678', section: '9th', totalFee: 12000, rollNumber: '903', address: 'Sarkhej, Ahmedabad', joinedDate: '2026-06-05' },
  { name: 'Sneha Patil', parentName: 'Vijay Patil', parentPhone: '9611234567', section: '9th', totalFee: 12000, rollNumber: '904', address: 'Paldi, Ahmedabad', joinedDate: '2026-06-10' },
  { name: 'Karan Joshi', parentName: 'Deepak Joshi', parentPhone: '9500123456', section: '10th', totalFee: 15000, rollNumber: '1001', address: 'Vasna, Ahmedabad', joinedDate: '2026-06-01' },
  { name: 'Neha Gupta', parentName: 'Ramesh Gupta', parentPhone: '9389012345', section: '10th', totalFee: 15000, rollNumber: '1002', address: 'Juhapura, Ahmedabad', joinedDate: '2026-06-01' },
  { name: 'Sahil Khan', parentName: 'Irfan Khan', parentPhone: '9278901234', section: '10th', totalFee: 15000, rollNumber: '1003', address: 'Sharifabad, Ahmedabad', joinedDate: '2026-06-03' },
  { name: 'Divya Nair', parentName: 'Sunil Nair', parentPhone: '9167890123', section: '10th', totalFee: 15000, rollNumber: '1004', address: 'Vejalpur, Ahmedabad', joinedDate: '2026-06-08' },
  { name: 'Arjun Singh', parentName: 'Gurpreet Singh', parentPhone: '9056789012', section: 'others', totalFee: 8000, rollNumber: 'O01', address: 'Juhapura, Ahmedabad', joinedDate: '2026-06-02' },
  { name: 'Tanvi Rao', parentName: 'Kishore Rao', parentPhone: '8945678901', section: 'others', totalFee: 8000, rollNumber: 'O02', address: 'Sarkhej, Ahmedabad', joinedDate: '2026-06-02' },
];
...
function getInitialPayments(byRoll) {
  return [
    ...
    { studentId: byRoll['902'], amount: 12000, date: '2026-06-02', mode: 'cash', receiptNumber: 'R-003', receiptNote: 'Full payment' },
    ...
    { studentId: byRoll['1002'], amount: 15000, date: '2026-06-03', mode: 'bank_transfer', receiptNumber: 'R-007', receiptNote: 'Full payment' },
    ...
    { studentId: byRoll['O02'], amount: 8000, date: '2026-06-03', mode: 'upi', receiptNumber: 'R-010', receiptNote: 'Full payment' },
  ];
}
...
const initialTimetable = [
  ...
  { section: '9th', day: 'Wednesday', subject: 'English', startTime: '09:00', endTime: '10:00', teacher: 'Firoz Sir' },
  { section: '9th', day: 'Wednesday', subject: 'History', startTime: '10:00', endTime: '11:00', teacher: 'Firoz Sir' },
  ...
  { section: 'others', day: 'Monday', subject: 'Maths & Science', startTime: '17:00', endTime: '18:30', teacher: 'Firoz Sir' },
  { section: 'others', day: 'Wednesday', subject: 'English & GK', startTime: '17:00', endTime: '18:30', teacher: 'Firoz Sir' },
  { section: 'others', day: 'Friday', subject: 'Maths Revision', startTime: '17:00', endTime: '18:30', teacher: 'Firoz Sir' },
];
